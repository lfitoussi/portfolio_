      ...
      >
        ...
        <div className="grid gap-7 p-5 sm:grid-cols-[1.2fr_1fr] sm:p-7">
          <div>
            ...
            <a href={selectedProject.href} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded bg-white px-5 py-2.5 text-sm font-semibold text-zinc-900 hover:bg-zinc-200" style={{ color: "#111111" }}>
